...
智学·多智能体当前答辩版收窄为《高数上》课程智能助教，面向基础薄弱学生。系统围绕“提问 → 教材检索 → 可信回答 → 自动生成学习资源 → 做题反馈 → 错题复盘 → 学习画像更新 → 个性化学习路径调整”的闭环，帮助学生把一个不会的问题拆成可学、可练、可复盘的学习过程。
...
| 多智能体资源生成 | 提问后自动生成思维导图、练习题、学习讲义、学习路径和 Markdown 教学版 PPT |
...
| 个性化资源包 | 围绕当前问题自动聚合讲义、可读知识树、练习题、学习路径、Markdown 教学版 PPT |
...
4. **右侧预览**：提问后自动出现导图、练习、讲义、学习路径、Markdown PPT 五类资源
